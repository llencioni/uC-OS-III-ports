...
// LRL
//#define  LIB_MEM_CFG_HEAP_SIZE          (8u * 1024u * 1024u)   /* Configure heap memory size         [see Note #2a].           */
#define  LIB_MEM_CFG_HEAP_SIZE          (0u)   /* Configure heap memory size         [see Note #2a].           */
